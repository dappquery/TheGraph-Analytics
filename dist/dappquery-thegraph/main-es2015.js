...
class ThegraphComponent {
    constructor(router, activatedRoute) {
        ...
        this.labels = src_core_utils_constant__WEBPACK_IMPORTED_MODULE_1__["Constants"].LABELS.theGraphDashboard;
    }
    ngOnInit() {
        ...
        switch (tab) {
            ...
            case 'tab3': {
                if (this.router.url.includes('curator')) {
                    if (this.activatedRoute.snapshot.queryParams['id']) {
                        this.dashboardUrl = this.activatedRoute.snapshot.queryParams['id']
                            ? `${this.constants.individualcuratorDashboard}?${this.createUrlWithAddress('curator')}`
            ...
            case 'tab4': {
                if (this.router.url.includes('subgraph')) {
                    if (this.activatedRoute.snapshot.queryParams['id']) {
                        this.dashboardUrl = this.activatedRoute.snapshot.queryParams['id']
                            ? `${this.constants.individualSubgraphDashboard}?${this.createUrlWithAddress('subgraph')}`
...
ThegraphComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ThegraphComponent, selectors: [["app-thegraph"]], decls: 17, vars: 19, consts: [[1, "tab-container"], [1, "tabs", 3, "ngClass", "click"], ["name", "indexerIcon", 1, "filter-icon"], ["name", "delegatorIcon", 1, "icons"], ["name", "curatorIcon", 1, "icons"], [1, "user-dashboard-container"], ["frameBorder", "0", 3, "src"]], template: function ThegraphComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](12, "app-svg-icon", 4);
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngClass", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpureFunction1"](11, _c0, ctx.isTab1Active));
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](2);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate1"]("", ctx.labels.indexerLabel, " ");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngClass", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpureFunction1"](13, _c0, ctx.isTab2Active));
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](2);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate1"]("", ctx.labels.delegatorLabel, " ");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngClass", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpureFunction1"](15, _c0, ctx.isTab3Active));
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](2);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate1"](" ", ctx.labels.curatorLabel, " ");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngClass", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpureFunction1"](17, _c0, ctx.isTab4Active));
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](2);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate1"](" ", ctx.labels.subgraphLabel, " ");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](2);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("src", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpipeBind1"](16, 9, ctx.dashboardUrl), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsanitizeResourceUrl"]);
    } }, directives: [_shared_logout_header_logout_header_component__WEBPACK_IMPORTED_MODULE_3__["LogoutHeaderComponent"], _angular_common__WEBPACK_IMPORTED_MODULE_4__["NgClass"], _utility_svg_icon_svg_icon_component__WEBPACK_IMPORTED_MODULE_5__["SvgIconComponent"]], pipes: [_utility_pipe_dom_sanitizer_pipe__WEBPACK_IMPORTED_MODULE_6__["DomSanitizerPipe"]], styles: ["@import url(\"https://fonts.googleapis.com/css?family=Heebo:300,400,500,700|Roboto:300,400,500,700\");\n\n\n\n.tab-container[_ngcontent-%COMP%] {\n  display: flex;\n  font-size: 14px;\n  font-weight: 400;\n  color: #fff;\n  margin-top: 1px;\n  text-transform: uppercase;\n  background: #3bacf0;\n  position: relative;\n}\n.tab-container[_ngcontent-%COMP%]   .tabs[_ngcontent-%COMP%] {\n  width: 17%;\n  text-align: center;\n  font-weight: 500;\n}\n.tab-container[_ngcontent-%COMP%]   .tabs[_ngcontent-%COMP%]:hover {\n  cursor: pointer;\n  background: #199df0;\n  border-radius: 6px;\n}\n.tab-container[_ngcontent-%COMP%]   .tabs.active[_ngcontent-%COMP%] {\n  border-radius: 6px;\n  border-top: 1px solid rgba(0, 0, 0, 0.1);\n  transition: all 0.25s ease;\n  background-color: #1392e1;\n  color: #fff;\n}\n  .icons #delegator {\n  height: 40px;\n  width: 40px;\n}\n  .icons #curator {\n  height: 45px;\n  width: 50px;\n}\niframe[_ngcontent-%COMP%] {\n  display: block;\n  width: 100%;\n  border: none;\n  overflow-y: auto;\n  overflow-x: hidden;\n  height: 100vh;\n}\n.user-dashboard-container[_ngcontent-%COMP%] {\n  min-height: 80vh;\n}\nhr[_ngcontent-%COMP%] {\n  margin-top: 1rem;\n  margin-bottom: 1rem;\n  border: 0;\n  border-top: 0 solid rgba(0, 0, 0, 0.1);\n}\n  .arrowIcon #arrow {\n  height: 20px;\n  width: 20px;\n  fill: white;\n}\n  .arrowIcon #arrowUp {\n  height: 20px;\n  width: 12px;\n  fill: white;\n}\n@media (min-width: 450px) and (max-width: 491px) {\n  .tab-container[_ngcontent-%COMP%] {\n    margin-top: 60px;\n  }\n}\n@media (max-width: 382px) {\n  .tab-container[_ngcontent-%COMP%] {\n    margin-top: 60px;\n  }\n}\n@media (min-width: 991px) and (max-width: 1200px) {\n  .tab-container[_ngcontent-%COMP%] {\n    margin-top: 19px;\n  }\n}\n.dropdown-content[_ngcontent-%COMP%] {\n  position: absolute;\n  background-color: #f9f9f9;\n  border: 2px solid #daf1f2;\n  border-radius: 4px;\n  box-shadow: 3px 3px 12px rgba(0, 0, 0, 0.175);\n  right: 2%;\n  width: 90%;\n  z-index: 1;\n  top: 100%;\n  margin-top: 2%;\n  min-width: 200px;\n}\n.dropdown-content[_ngcontent-%COMP%]   a[_ngcontent-%COMP%] {\n  float: none;\n  color: black;\n  padding: 12px 16px;\n  text-decoration: none;\n  display: block;\n  text-align: left;\n  font-weight: 400;\n}\n.dropdown-content[_ngcontent-%COMP%]   a[_ngcontent-%COMP%]:hover {\n  background-color: #199df0;\n  color: white;\n}\n@media (max-width: 500px) {\n  .tab-container[_ngcontent-%COMP%] {\n    flex-flow: column;\n  }\n  .tab-container[_ngcontent-%COMP%]   .tabs[_ngcontent-%COMP%] {\n    width: 100%;\n    border-bottom: 1px solid white;\n  }\n\n  .dropdown-content[_ngcontent-%COMP%] {\n    right: 25%;\n    width: 50%;\n  }\n}\n.dropdowm-container[_ngcontent-%COMP%] {\n  display: flex;\n  justify-content: center;\n  flex-wrap: nowrap;\n  flex-flow: row;\n  align-items: center;\n  position: relative;\n}\n/*# sourceMappingURL=data:application/json;base64, */"] });
...
HeaderMenuAreaComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: HeaderMenuAreaComponent, selectors: [["app-header-menu-area"]], hostBindings: function HeaderMenuAreaComponent_HostBindings(rf, ctx) { if (rf & 1) {
    ...
    } }, directives: [_utility_svg_icon_svg_icon_component__WEBPACK_IMPORTED_MODULE_3__["SvgIconComponent"], _angular_common__WEBPACK_IMPORTED_MODULE_4__["NgIf"]], styles: ["ul.dropdown-menu[_ngcontent-%COMP%] {\n  position: absolute !important;\n  top: 75px !important;\n}\n\n  .new_icon {\n  position: absolute;\n  top: -10%;\n}\n\n  .new_icon svg {\n  height: 30px;\n  width: 30px;\n}\n\n.header_area[_ngcontent-%COMP%] {\n  top: -7px;\n}\n\n  .menu-icon {\n  position: relative;\n  bottom: 2px;\n}\n\n  .menu-icon svg {\n  height: 16px;\n  width: 16px;\n  fill: #fff;\n}\n\n@media only screen and (min-width: 780px) {\n  .menu-icon[_ngcontent-%COMP%] {\n    position: relative;\n    bottom: 2px;\n  }\n  .menu-icon[_ngcontent-%COMP%]   svg[_ngcontent-%COMP%] {\n    height: 16px;\n    width: 16px;\n    fill: #fff;\n  }\n\n  .button-link[_ngcontent-%COMP%] {\n    font: 500 12px/39px \"Roboto\", sans-serif !important;\n    text-transform: uppercase;\n    color: #fff;\n    padding: 0 10px !important;\n    border-radius: 10px;\n    margin-top: 31px;\n    background-color: #1b5a90;\n  }\n}\n\n@media (max-width: 1200px) {\n  .header_area[_ngcontent-%COMP%]   .navbar[_ngcontent-%COMP%] {\n    background: #000;\n  }\n\n  .header_area[_ngcontent-%COMP%]   .navbar[_ngcontent-%COMP%]   .nav[_ngcontent-%COMP%]   .nav-item[_ngcontent-%COMP%]   .nav-link[_ngcontent-%COMP%] {\n    font: 500 12px/50px \"Roboto\", sans-serif;\n  }\n}\n\n@media (min-width: 1200px) {\n  .box_1620[_ngcontent-%COMP%] {\n    max-width: 1650px;\n    margin: auto;\n  }\n}\n\n@media (max-width: 1200px) and (min-width: 991px) {\n  .button-link[_ngcontent-%COMP%] {\n    margin-top: 0;\n  }\n}\n/*# sourceMappingURL=data:application/json;base64, */"] });
...
Constants.individualcuratorDashboard = `https://analytics.dappquery.com/public/dashboard/a16e7dd8-c0c0-4f57-9c0d-dec5419d8f6a`;
Constants.subgraphDashboard = `http://analytics.dappquery.com/public/dashboard/ecee9e7c-8f90-4932-9a61-7aa6c22bcc1b`;
Constants.individualSubgraphDashboard = `http://analytics.dappquery.com/public/dashboard/5bf2f8f3-e8e9-4b12-8098-f6092374077c`;
Constants.GENERAL = {
